  ...
  return (
    <section className="relative overflow-hidden bg-navy py-20 text-white md:py-28">
      <div
        ...
        style={{ background: "radial-gradient(circle at 70% 30%, #F26B21, transparent 55%)" }}
      />
      <div className="relative mx-auto max-w-7xl px-4 md:px-6" ref={ref}>
        <div className="reveal flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="font-display text-[clamp(1.9rem,4vw,3rem)] font-semibold leading-tight">
              India&apos;s luxury tourist trains
            </h2>
          </div>
